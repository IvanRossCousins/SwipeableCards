...
const KNOWN_CARD = "cardKnown";
const UNKNOWN_CARD = "cardUnknown";
  ...
  mounted() {
    ...
    interact(element).draggable({
      ...
      onend: () => {
        ...
        if (x > interactXThreshold) this.playCard(KNOWN_CARD);
        else if (x < -interactXThreshold) this.playCard(UNKNOWN_CARD);
